...
<form action="" method="post" class="was-validated col-lg-4"
      style="position: absolute;right:33%;top:120px;direction: rtl;float: right !important;background-color:bisque;border-radius: 5px;padding: 20px ">
...
if (isset($_POST['submit']))
{
    ...
    $sql = "SELECT * FROM tarahposter WHERE (username=? or email=?) and password =?";
