...
<form action="" method="post" class="was-validated col-lg-4"
      style="position: absolute;right:33%;top:120px;direction: rtl;float: right !important;background-color:gainsboro;border-radius: 5px;padding: 20px ">
...
if (isset($_POST['submit']))
{
    ...
    $sql = "SELECT * FROM tarahlogo WHERE (username=? or email=?) and password =?";
    ...
    if ($database) {
        if ($result) {
            ...
            echo "<script>window.location.href='memberlogo.php'</script>";
        }
        else
        {
