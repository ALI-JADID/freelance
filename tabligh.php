              ...
              -->
                <div class="table-responsive">
                    <table id="mytable" class="table table-bordered table-striped m-2">
                        ...
                        $sql = "SELECT username,email,phone,code,time,content FROM tablighat" ;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                <?php echo htmlentities($results->code) ?>
                                </td>
                                <td>
                                <?php  echo htmlentities($results->time) ?>
                                </td>
                                <td>
                                <?php echo htmlentities($results->content) ?>
                                </td>
                            
                                <td><a href="tabligh.php?del="<?php echo htmlentities($results->username)?>><button class="btn btn-danger" onClick="return confirm('آیا حذف انجام شود');"><span class="glyphicon glyphicon-remove-circle"></span></button></a></td>
                            </tr>
                        <?php
