                    ...
                    <table id="mytable" class="table table-bordered table-striped m-2">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="typemember.php?del="<?php echo htmlentities($results->username)?>><button class="btn btn-danger" onClick="return confirm('آیا حذف انجام شود');"><span class="glyphicon glyphicon-remove-circle"></span></button></a></td>
                            </tr>
                        <?php
