...
<h4 style="text-align: center;margin: 40px">کاتالوگ</h4>
</div>

<form action="" method="post" class="was-validated col-lg-4" style="margin-bottom: 50px;position: absolute;right:33%;direction: rtl;float: right !important;background-color:aquamarine;border-radius: 5px;padding: 20px " enctype="multipart/form-data">
...
if (isset($_POST['submit'])) {
    ...
    $sql = ("INSERT INTO catalog (username,email,phone,code,content) VALUES  (?,?,?,?,?)");
